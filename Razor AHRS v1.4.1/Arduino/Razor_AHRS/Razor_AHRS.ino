...
// OUTPUT OPTIONS
/*****************************************************************/
// Set your serial port baud rate used to send out data here! ABY
...
#define OUTPUT__MODE_SENSORS_BOTH 4 // Outputs calibr ated AND raw sensor values for all 9 axes
...
#define ACCEL_X_MIN ((float) -275)  //-250)
#define ACCEL_X_MAX ((float) 252)   //250)
#define ACCEL_Y_MIN ((float) -260)  //-250)
#define ACCEL_Y_MAX ((float) 285)   //250)
#define ACCEL_Z_MIN ((float) -276)  //-250)
#define ACCEL_Z_MAX ((float) 257)   //250)
...
//-30.00/-29.38  -31.00/-30.77  -7.00/-7.30
//-30.00/-29.34  -31.00/-30.69  -8.00/-7.44
//-29.00/-29.32  -31.00/-30.70  -7.00/-7.38
//-26.00/-29.79  -31.00/-29.92  -9.00/-7.35
// Earlier all zeros
#define GYRO_AVERAGE_OFFSET_X ((float) -29.79)
#define GYRO_AVERAGE_OFFSET_Y ((float) -29.92)
#define GYRO_AVERAGE_OFFSET_Z ((float) -7.35)
...
#endif
  delay(1000); // Give the micro time to breath ABY
}
